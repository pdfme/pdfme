...
- heading scale / heading margin、paragraph spacing、lineHeight、list spacing、table style、code block
  background、blockquote background / indent、horizontal rule color を決める。
...
- code block の本格的な padding / monospace / syntax highlight は text schema だけでは限界があるため、
  layout 品質フォローアップで扱う。
