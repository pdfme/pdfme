 ...
 * @property {(key: string, value: string) => void} [onCustomAttributeChange] - Used to change another attribute for the schema. Only applicable when the mode is 'form' or 'designer'.
