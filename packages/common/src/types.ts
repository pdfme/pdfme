...
/**
 * Type for the properties passed when the default schema is generated by a function.
 * @property {UIOptions} options - Options object passed from the Viewer, Form, or Designer.
 */
export type DefaultSchemaProps = {
  options: UIOptions;
};
 ...
 * @property {T | (props: DefaultSchemaProps) => T} defaultSchema - The default schema set when adding the schema, either a static object or a function that returns a schema object.
 */
export interface PropPanel<T extends Schema> {
  ...
  defaultSchema: T | ((props?: DefaultSchemaProps) => T);
}
