...
const LOCALE_MAP: Record<string, Locale> = {
  ar: { label: 'Arabic', formatLocale: dateFns.ar },
  bg: { label: 'Bulgarian', formatLocale: dateFns.bg },
  ca: { label: 'Catalan', formatLocale: dateFns.ca },
  cs: { label: 'Czech', formatLocale: dateFns.cs },
  da: { label: 'Danish', formatLocale: dateFns.da },
  de: { label: 'German', formatLocale: dateFns.de },
  el: { label: 'Greek', formatLocale: dateFns.el },
  en: { label: 'English', formatLocale: dateFns.enUS },
  es: { label: 'Spanish', formatLocale: dateFns.es },
  eu: { label: 'Basque', formatLocale: dateFns.eu },
  fi: { label: 'Finnish', formatLocale: dateFns.fi },
  fr: { label: 'French', formatLocale: dateFns.fr },
  hr: { label: 'Croatian', formatLocale: dateFns.hr },
  hu: { label: 'Hungarian', formatLocale: dateFns.hu },
  id: { label: 'Indonesian', formatLocale: dateFns.id },
  it: { label: 'Italian', formatLocale: dateFns.it },
  ja: { label: 'Japanese', formatLocale: dateFns.ja },
  ko: { label: 'Korean', formatLocale: dateFns.ko },
  nb: { label: 'Norwegian Bokmål', formatLocale: dateFns.nb },
  nl: { label: 'Dutch', formatLocale: dateFns.nl },
  pl: { label: 'Polish', formatLocale: dateFns.pl },
  'pt-Br': { label: 'Portuguese', formatLocale: dateFns.ptBR },
  pt: { label: 'Portuguese', formatLocale: dateFns.pt },
  ro: { label: 'Romanian', formatLocale: dateFns.ro },
  ru: { label: 'Russian', formatLocale: dateFns.ru },
  si: { label: 'Sinhala', formatLocale: dateFns.enUS },
  sk: { label: 'Slovak', formatLocale: dateFns.sk },
  sl: { label: 'Slovenian', formatLocale: dateFns.sl },
  sv: { label: 'Swedish', formatLocale: dateFns.sv },
  th: { label: 'Thai', formatLocale: dateFns.th },
  tr: { label: 'Turkish', formatLocale: dateFns.tr },
  uk: { label: 'Ukrainian', formatLocale: dateFns.uk },
  zh: { label: 'Chinese', formatLocale: dateFns.zhCN },
};
