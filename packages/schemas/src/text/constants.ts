...
export const TEXT_FORMAT_PLAIN = 'plain' as TEXT_FORMAT;
export const TEXT_FORMAT_INLINE_MARKDOWN = 'inline-markdown' as TEXT_FORMAT;
export const DEFAULT_TEXT_FORMAT = TEXT_FORMAT_PLAIN;
export const FONT_VARIANT_FALLBACK_SYNTHETIC = 'synthetic' as FONT_VARIANT_FALLBACK;
export const FONT_VARIANT_FALLBACK_PLAIN = 'plain' as FONT_VARIANT_FALLBACK;
export const FONT_VARIANT_FALLBACK_ERROR = 'error' as FONT_VARIANT_FALLBACK;
