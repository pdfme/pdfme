...
import {
  getDynamicHeightsForTable as _getDynamicHeightsForTable,
  getDynamicLayoutForTable as _getDynamicLayoutForTable,
...
export const getDynamicLayoutForTable = _getDynamicLayoutForTable;
