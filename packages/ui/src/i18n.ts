...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textFormat': 'Text Format',
  'schemas.text.defaultFont': 'Default',
  'schemas.text.plain': 'Plain',
  'schemas.text.inlineMarkdown': 'Inline Markdown',
...
const dictZh: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textFormat': '文本格式',
  'schemas.text.defaultFont': '默认',
  'schemas.text.plain': '纯文本',
  'schemas.text.inlineMarkdown': '内联 Markdown',
...
const dictJa: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textFormat': 'テキスト形式',
  'schemas.text.defaultFont': 'デフォルト',
  'schemas.text.plain': 'プレーン',
  'schemas.text.inlineMarkdown': 'インラインMarkdown',
...
const dictKo: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textFormat': '텍스트 형식',
  'schemas.text.defaultFont': '기본값',
  'schemas.text.plain': '일반 텍스트',
  'schemas.text.inlineMarkdown': '인라인 Markdown',
...
const dictAr: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textFormat': 'تنسيق النص',
  'schemas.text.defaultFont': 'افتراضي',
  'schemas.text.plain': 'نص عادي',
  'schemas.text.inlineMarkdown': 'ماركداون مضمن',
...
const dictTh: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textFormat': 'รูปแบบข้อความ',
  'schemas.text.defaultFont': 'ค่าเริ่มต้น',
  'schemas.text.plain': 'ข้อความธรรมดา',
  'schemas.text.inlineMarkdown': 'Markdown แบบอินไลน์',
...
const dictIt: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textFormat': 'Formato testo',
  'schemas.text.defaultFont': 'Predefinito',
  'schemas.text.plain': 'Testo semplice',
  'schemas.text.inlineMarkdown': 'Markdown inline',
...
const dictPl: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.format': 'Format',
  'schemas.text.textFormat': 'Format tekstu',
  'schemas.text.defaultFont': 'Domyślne',
...
const dictDe: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.format': 'Format',
  'schemas.text.textFormat': 'Textformat',
  'schemas.text.defaultFont': 'Standard',
...
const dictEs: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.format': 'Formato',
  'schemas.text.textFormat': 'Formato de texto',
  'schemas.text.defaultFont': 'Predeterminado',
  'schemas.text.plain': 'Texto sin formato',
  'schemas.text.inlineMarkdown': 'Markdown en línea',
...
const dictFr: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.format': 'Format',
  'schemas.text.textFormat': 'Format du texte',
  'schemas.text.defaultFont': 'Par défaut',
  'schemas.text.plain': 'Texte brut',
  'schemas.text.inlineMarkdown': 'Markdown en ligne',
