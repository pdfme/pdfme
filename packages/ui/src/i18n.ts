...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': 'Repeat Header',
...
const dictZh: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': '重复标题',
...
const dictJa: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': 'ヘッダーを繰り返す',
...
const dictKo: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': '헤더 반복',
...
const dictAr: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': 'تكرار الرأس',
...
const dictTh: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': 'ทำซ้ำหัวข้อ',
...
const dictIt: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': 'Ripeti Intestazione',
...
const dictPl: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': 'Powtórz nagłówek',
...
const dictDe: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': 'Kopfzeile wiederholen',
...
const dictEs: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': 'Repetir encabezado',
...
const dictFr: { [key in keyof Dict]: string } = {
  ...
  'schemas.table.headerRepeat': "Répéter l'en-tête",
