...
const dictAr: { [key in keyof DictEn]: string } = {
  ...
  plsAddNewField: 'الرجاء إضافة حقل جديد',
  ...
  type: 'النوع',
  goToFirst: 'الذهاب إلى الصفحة الأولى',
  goToPrevious: 'الذهاب إلى الصفحة السابقة',
  goToNext: 'الذهاب إلى الصفحة التالية',
  goToEnd: 'الذهاب إلى الصفحة الأخيرة',
  select: 'اختر',
  zoomIn: 'تكبير',
  zoomOut: 'تصغير',
