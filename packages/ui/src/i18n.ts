...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': 'Font Weight',
  'schemas.text.fontStyle': 'Font Style',
  'schemas.text.fontStyleNormal': 'Normal',
  'schemas.text.fontStyleItalic': 'Italic',
...
const dictZh: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': '字体粗细',
  'schemas.text.fontStyle': '字体样式',
  'schemas.text.fontStyleNormal': '正常',
  'schemas.text.fontStyleItalic': '斜体',
...
const dictJa: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': 'フォントの太さ',
  'schemas.text.fontStyle': 'フォントスタイル',
  'schemas.text.fontStyleNormal': '通常',
  'schemas.text.fontStyleItalic': 'イタリック',
...
const dictKo: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': '글꼴 굵기',
  'schemas.text.fontStyle': '글꼴 스타일',
  'schemas.text.fontStyleNormal': '보통',
  'schemas.text.fontStyleItalic': '기울임꼴',
...
const dictAr: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': 'وزن الخط',
  'schemas.text.fontStyle': 'نمط الخط',
  'schemas.text.fontStyleNormal': 'عادي',
  'schemas.text.fontStyleItalic': 'مائل',
...
const dictTh: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': 'น้ำหนักแบบอักษร',
  'schemas.text.fontStyle': 'รูปแบบแบบอักษร',
  'schemas.text.fontStyleNormal': 'ปกติ',
  'schemas.text.fontStyleItalic': 'ตัวเอียง',
...
const dictIt: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': 'Peso del carattere',
  'schemas.text.fontStyle': 'Stile del carattere',
  'schemas.text.fontStyleNormal': 'Normale',
  'schemas.text.fontStyleItalic': 'Corsivo',
...
const dictPl: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': 'Grubość czcionki',
  'schemas.text.fontStyle': 'Styl czcionki',
  'schemas.text.fontStyleNormal': 'Normalny',
  'schemas.text.fontStyleItalic': 'Kursywa',
...
const dictDe: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': 'Schriftstärke',
  'schemas.text.fontStyle': 'Schriftstil',
  'schemas.text.fontStyleNormal': 'Normal',
  'schemas.text.fontStyleItalic': 'Kursiv',
...
const dictEs: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': 'Grosor de la fuente',
  'schemas.text.fontStyle': 'Estilo de fuente',
  'schemas.text.fontStyleNormal': 'Normal',
  'schemas.text.fontStyleItalic': 'Cursiva',
...
const dictFr: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.fontWeight': 'Graisse de la police',
  'schemas.text.fontStyle': 'Style de police',
  'schemas.text.fontStyleNormal': 'Normal',
  'schemas.text.fontStyleItalic': 'Italique',
