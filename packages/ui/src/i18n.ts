...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textIndent': 'Text Indent',
...
const dictJa: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textIndent': 'テキストインデント',
  'schemas.text.min': '最小',
  'schemas.text.max': '最大',
...
const dictKo: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textIndent': '텍스트 들여쓰기',
  'schemas.text.min': '최소',
  'schemas.text.max': '최대',
  'schemas.text.fit': '맞춤',
...
const dictAr: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textIndent': 'مسافة بادئة للنص',
...
const dictTh: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textIndent': 'การเยื้องข้อความ',
...
const dictIt: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textIndent': 'Indentazione testo',
...
const dictPl: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textIndent': 'Wcięcie tekstu',
...
const dictDe: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textIndent': 'Texteinzug',
  'schemas.text.min': 'Min',
  'schemas.text.max': 'Max',
...
const dictEs: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textIndent': 'Sangría de texto',
...
const dictFr: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.textIndent': 'Retrait du texte',
  'schemas.text.min': 'Min',
  'schemas.text.max': 'Max',
