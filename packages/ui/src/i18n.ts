...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': 'Marker',
  'schemas.list.startNumber': 'Start Number',
  'schemas.list.orderedSuffix': 'Ordered Suffix',
...
const dictZh: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': '标记',
  'schemas.list.startNumber': '起始编号',
  'schemas.list.orderedSuffix': '编号后缀',
...
const dictJa: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': 'マーカー',
  'schemas.list.startNumber': '開始番号',
  'schemas.list.orderedSuffix': '番号サフィックス',
...
const dictKo: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': '마커',
  'schemas.list.startNumber': '시작 번호',
  'schemas.list.orderedSuffix': '번호 접미사',
...
const dictAr: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': 'علامة',
  'schemas.list.startNumber': 'رقم البداية',
  'schemas.list.orderedSuffix': 'لاحقة الرقم',
...
const dictTh: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': 'เครื่องหมาย',
  'schemas.list.startNumber': 'หมายเลขเริ่มต้น',
  'schemas.list.orderedSuffix': 'คำต่อท้ายหมายเลข',
...
const dictIt: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': 'Indicatore',
  'schemas.list.startNumber': 'Numero iniziale',
  'schemas.list.orderedSuffix': 'Suffisso numerazione',
...
const dictPl: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': 'Znacznik',
  'schemas.list.startNumber': 'Numer początkowy',
  'schemas.list.orderedSuffix': 'Sufiks numeracji',
...
const dictDe: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': 'Marker',
  'schemas.list.startNumber': 'Startnummer',
  'schemas.list.orderedSuffix': 'Nummerierungssuffix',
...
const dictEs: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': 'Marcador',
  'schemas.list.startNumber': 'Número inicial',
  'schemas.list.orderedSuffix': 'Sufijo de numeración',
...
const dictFr: { [key in keyof Dict]: string } = {
  ...
  'schemas.list.marker': 'Marqueur',
  'schemas.list.startNumber': 'Numéro de départ',
  'schemas.list.orderedSuffix': 'Suffixe de numérotation',
