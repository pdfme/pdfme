...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': 'Invalid locale string',
  'schemas.color': 'Color',
...
const dictZh: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': '区域设置字符串无效',
  'schemas.color': '颜色',
...
const dictJa: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': '不正なロケール名です',
  'schemas.color': '色',
...
const dictKo: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': '잘못된 로케일 문자열',
  'schemas.color': '색상',
...
const dictAr: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': 'سلسلة لغة غير صالحة',
  'schemas.color': 'اللون',
...
const dictTh: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': 'สตริงสถานที่ไม่ถูกต้อง',
  'schemas.color': 'สี',
...
const dictIt: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': 'Stringa locale non valida',
...
const dictPl: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': 'Nieprawidłowy ciąg ustawień regionalnych',
  'schemas.color': 'Kolor',
...
const dictDe: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': 'Ungültige Gebietsschemazeichenfolge',
  'schemas.color': 'Farbe',
  ...
  'schemas.text.format': 'Format',
  'schemas.text.locale': 'Gebietsschema',
  'schemas.mvt.typingInstructions':
  ...
  'schemas.table.locale': 'Gebietsschema',
...
const dictEs: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': 'Cadena de configuración regional no válida',
  'schemas.color': 'Color',
...
const dictFr: { [key in keyof Dict]: string } = {
  ...
  'validation.segmenterLocale': 'Chaîne de paramètres régionaux non valide',
