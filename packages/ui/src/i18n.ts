...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': 'Alt Text',
  'schemas.textYOffset': 'Text Y Offset',
  'schemas.scale': 'Scale',
  'schemas.showBorder': 'Show Border',
  'schemas.outputFormat': 'Output Format',
  'schemas.qr.eclevel': 'Error Correction',
  'schemas.qr.version': 'QR Version',
  'schemas.qr.mask': 'Mask',
  'schemas.qr.qzone': 'Quiet Zone',
  'schemas.pdf417.columns': 'Columns',
  'schemas.pdf417.rows': 'Rows',
  'schemas.pdf417.compact': 'Compact',
  'schemas.pdf417.eclevel': 'Error Correction',
...
const dictZh: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': '替代文本',
  'schemas.textYOffset': '文本Y偏移',
  'schemas.scale': '比例',
  'schemas.showBorder': '显示边框',
  'schemas.outputFormat': '输出格式',
  'schemas.qr.eclevel': '纠错级别',
  'schemas.qr.version': 'QR版本',
  'schemas.qr.mask': '掩码',
  'schemas.qr.qzone': '静区',
  'schemas.pdf417.columns': '列',
  'schemas.pdf417.rows': '行',
  'schemas.pdf417.compact': '压缩',
  'schemas.pdf417.eclevel': '纠错',
...
const dictJa: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': '代替テキスト',
  'schemas.textYOffset': 'テキストYオフセット',
  'schemas.scale': 'スケール',
  'schemas.showBorder': '枠線を表示',
  'schemas.outputFormat': '出力形式',
  'schemas.qr.eclevel': '誤り訂正',
  'schemas.qr.version': 'QRバージョン',
  'schemas.qr.mask': 'マスク',
  'schemas.qr.qzone': 'クワイエットゾーン',
  'schemas.pdf417.columns': '列',
  'schemas.pdf417.rows': '行',
  'schemas.pdf417.compact': 'コンパクト',
  'schemas.pdf417.eclevel': '誤り訂正',
...
const dictKo: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': '대체 텍스트',
  'schemas.textYOffset': '텍스트 Y 오프셋',
  'schemas.scale': '스케일',
  'schemas.showBorder': '테두리 표시',
  'schemas.outputFormat': '출력 형식',
  'schemas.qr.eclevel': '오류 정정',
  'schemas.qr.version': 'QR 버전',
  'schemas.qr.mask': '마스크',
  'schemas.qr.qzone': '정숙 영역',
  'schemas.pdf417.columns': '열',
  'schemas.pdf417.rows': '행',
  'schemas.pdf417.compact': '컴팩트',
  'schemas.pdf417.eclevel': '오류 정정',
...
const dictAr: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': 'نص بديل',
  'schemas.textYOffset': 'إزاحة Y للنص',
  'schemas.scale': 'المقياس',
  'schemas.showBorder': 'إظهار الحدود',
  'schemas.outputFormat': 'صيغة الإخراج',
  'schemas.qr.eclevel': 'تصحيح الخطأ',
  'schemas.qr.version': 'إصدار QR',
  'schemas.qr.mask': 'قناع',
  'schemas.qr.qzone': 'المنطقة الهادئة',
  'schemas.pdf417.columns': 'الأعمدة',
  'schemas.pdf417.rows': 'الصفوف',
  'schemas.pdf417.compact': 'مضغوط',
  'schemas.pdf417.eclevel': 'تصحيح الخطأ',
...
const dictTh: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': 'ข้อความทางเลือก',
  'schemas.textYOffset': 'ออฟเซ็ต Y ของข้อความ',
  'schemas.scale': 'สเกล',
  'schemas.showBorder': 'แสดงเส้นขอบ',
  'schemas.outputFormat': 'รูปแบบเอาต์พุต',
  'schemas.qr.eclevel': 'การแก้ไขข้อผิดพลาด',
  'schemas.qr.version': 'เวอร์ชัน QR',
  'schemas.qr.mask': 'มาสก์',
  'schemas.qr.qzone': 'โซนเงียบ',
  'schemas.pdf417.columns': 'คอลัมน์',
  'schemas.pdf417.rows': 'แถว',
  'schemas.pdf417.compact': 'กะทัดรัด',
  'schemas.pdf417.eclevel': 'การแก้ไขข้อผิดพลาด',
...
const dictIt: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': 'Testo alternativo',
  'schemas.textYOffset': 'Offset Y del testo',
  'schemas.scale': 'Scala',
  'schemas.showBorder': 'Mostra bordo',
  'schemas.outputFormat': 'Formato di output',
  'schemas.qr.eclevel': 'Correzione errori',
  'schemas.qr.version': 'Versione QR',
  'schemas.qr.mask': 'Maschera',
  'schemas.qr.qzone': 'Zona silenziosa',
  'schemas.pdf417.columns': 'Colonne',
  'schemas.pdf417.rows': 'Righe',
  'schemas.pdf417.compact': 'Compatto',
  'schemas.pdf417.eclevel': 'Correzione errori',
...
const dictPl: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': 'Tekst alternatywny',
  'schemas.textYOffset': 'Przesunięcie Y tekstu',
  'schemas.scale': 'Skala',
  'schemas.showBorder': 'Pokaż obramowanie',
  'schemas.outputFormat': 'Format wyjściowy',
  'schemas.qr.eclevel': 'Korekcja błędów',
  'schemas.qr.version': 'Wersja QR',
  'schemas.qr.mask': 'Maska',
  'schemas.qr.qzone': 'Strefa ciszy',
  'schemas.pdf417.columns': 'Kolumny',
  'schemas.pdf417.rows': 'Wiersze',
  'schemas.pdf417.compact': 'Kompaktowy',
  'schemas.pdf417.eclevel': 'Korekcja błędów',
...
const dictDe: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': 'Alternativtext',
  'schemas.textYOffset': 'Text-Y-Offset',
  'schemas.scale': 'Skalierung',
  'schemas.showBorder': 'Rahmen anzeigen',
  'schemas.outputFormat': 'Ausgabeformat',
  'schemas.qr.eclevel': 'Fehlerkorrektur',
  'schemas.qr.version': 'QR-Version',
  'schemas.qr.mask': 'Maske',
  'schemas.qr.qzone': 'Ruhezone',
  'schemas.pdf417.columns': 'Spalten',
  'schemas.pdf417.rows': 'Zeilen',
  'schemas.pdf417.compact': 'Kompakt',
  'schemas.pdf417.eclevel': 'Fehlerkorrektur',
...
const dictEs: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': 'Texto alternativo',
  'schemas.textYOffset': 'Desplazamiento Y de texto',
  'schemas.scale': 'Escala',
  'schemas.showBorder': 'Mostrar borde',
  'schemas.outputFormat': 'Formato de salida',
  'schemas.qr.eclevel': 'Corrección de errores',
  'schemas.qr.version': 'Versión QR',
  'schemas.qr.mask': 'Máscara',
  'schemas.qr.qzone': 'Zona tranquila',
  'schemas.pdf417.columns': 'Columnas',
  'schemas.pdf417.rows': 'Filas',
  'schemas.pdf417.compact': 'Compacto',
  'schemas.pdf417.eclevel': 'Corrección de errores',
...
const dictFr: { [key in keyof Dict]: string } = {
  ...
  'schemas.altText': 'Texte alternatif',
  'schemas.textYOffset': 'Décalage Y du texte',
  'schemas.scale': 'Échelle',
  'schemas.showBorder': 'Afficher la bordure',
  'schemas.outputFormat': 'Format de sortie',
  'schemas.qr.eclevel': 'Correction d’erreurs',
  'schemas.qr.version': 'Version QR',
  'schemas.qr.mask': 'Masque',
  'schemas.qr.qzone': 'Zone de silence',
  'schemas.pdf417.columns': 'Colonnes',
  'schemas.pdf417.rows': 'Lignes',
  'schemas.pdf417.compact': 'Compact',
  'schemas.pdf417.eclevel': 'Correction d’erreurs',
