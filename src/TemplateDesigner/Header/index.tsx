...
const Header = (
  { processing, template, saveTemplate, updateTemplate }: TemplateDesignerHeaderProp,
      ...
      <div className={`${styles.desktopFlex}`}>
        <div style={{ display: 'flex', marginTop: '0.75rem', justifyContent: 'flex-end' }}>
          ...
          <button disabled={processing}>
            <img src={pdfIcon} alt={'Change Base PDF'} />
            Change Base PDF
            <input
              type="file"
...
export default forwardRef<HTMLDivElement, TemplateDesignerHeaderProp>(Header);
